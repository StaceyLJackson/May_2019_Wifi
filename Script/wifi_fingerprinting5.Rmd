...
ggplot(validationDataBuilding0, mapping=aes(x=original_floor, y=BUILDINGID)) +
...
```
PLOTS OF ERRORS FOR FLOORS
```{r}


plot(validationDataBuilding2$original_floor,validationDataBuilding2$FLOOR)
